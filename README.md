...
- User photos update: `POST /user/photos` replaces the authenticated user's photo URLs (max 3).
...
- Service payloads now support up to 3 photo URLs and service reads return ordered `photos`.
